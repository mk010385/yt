...
try:
    ...
    st.markdown(f"<h1 style='text-align: center; color: Tomato;'>YouTube Comment Analysis of our IISR-Channel</h1>", unsafe_allow_html=True)
    ...
    api_version = "v3"
    DEVELOPER_KEY = "AIzaSyANpzCVkmvylEAvr-QjryM1cg9uWaU78Tc"
